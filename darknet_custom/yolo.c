...
void run_yolo(int argc, char **argv)
{
	...
	//char *train_images = "C:\\deeplearning\\darknet\\build\\darknet\\x64\\data\\nfpa\\train.txt";// / data / voc / train.txt";
	//char *backup_directory = "C:\\deeplearning\\darknet\\build\\darknet\\x64\\backup\\";// / home / pjreddie / backup / ";

    printf("Train from %s %s\n",train_images,backup_directory);
	//darknet yolo train "data\\nfpa\\tiny-yolo-v1-obj.cfg" -train "C:\\deeplearning\\darknet\\build\\darknet\\x64\\data\\nfpa\\train.txt" -backup "C:\\deeplearning\\darknet\\build\\darknet\\x64\\backup\\" -class 1
